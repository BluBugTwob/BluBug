/*
  ...
  control the four Dc motor direction with this code.
  use to create the fourwheel robot.
...
if(Serial.available())                      // Check for available serial available data
{
  ...
  if(botdata=='f')                         
  {
    mybot.fourwheelforward();                // if received value is 'f' move bot forward
  }
  else if(botdata=='b')
  {
    mybot.fourwheelreverse();                // if received value is 'b' move bot reverse
  }
  else if(botdata=='l')
  {
    mybot.fourwheelleft();                   // if received value is 'l' move bot left
  }
  else if(botdata=='r')
  {
    mybot.fourwheelreverse();                // if received value is 'r' move bot reverse
  }
  else if(botdata=='w')
  {
    mybot.fourwheelstop();                   // if received value is 'w' stop bot 
  }
 }
}
